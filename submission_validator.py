...
conf = {
    ...
    "specified_files": ["server/server.cpp", "README", "Makefile", "server/Makefile", 
    "client/client.py", "server/wdigraph.h", "server/digraph.h", "server/digraph.cpp", "server/dijkstra.h", "server/dijkstra.cpp", 
    "server/edmonton-roads-2.0.1.txt", "map/10.png", "map/11.png", "map/12.png", "map/13.png", "map/14.png", "map/15.png"],
    "assignment_version": "Assignment #1 Part 2",
}
